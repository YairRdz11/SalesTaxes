...
namespace SalesTaxesTest
{
    public class Tests
    {
        ...
        {
            var basic = new Basic("Music CD", 14.99);
        ...
        {
            var imported = new ImportedBasic("Imported bottle of perfume", 47.50);
        ...
        {
            var exempt = new Exempt("Book", 12.49);
        ...
        public void ttp_GetSalesTaxesFromProductToBasket()
        {
            ...
            var exempt = new Exempt( "Packet of headache", 12.49);
